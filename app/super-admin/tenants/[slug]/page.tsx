          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <input value={secondaryColor} onChange={e => setSecondaryColor(e.target.value)}
                className="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Optional" />
            </div>
          </div>
          <div className="flex flex-col gap-1.5">
